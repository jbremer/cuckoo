...
report = {
    ...
    "behavior": {
        "summary": {
            "files": [
                "C:\\Users\\Administrator\\AppData\\Local\\Microsoft\\Windows\\Temporary Internet Files\\Content.MSO\\94986FA4.gif",
            ],
            "keys": [
                "test1",
            ],
            "mutex": [
                "Global\\{754E1424-2073-665E-296D-2E3CE0A0FF4B}",
            ],
            "regkey_read": [
    ...
    "signatures": [{
        ...
        "description": (
            "Checks amount of memory in system, this can be used to "
            "detect virtual machines that have a low amount of memory "
            "available"
        ),
    }],
    "strings": [
...
def test_mongo_search():
    ...
    db.connect()
    report["info"]["id"] = db.add_path(__file__)
    ...
    do_search("ip", report["network"]["hosts"][0])
    do_search(None, report["network"]["hosts"][0])
